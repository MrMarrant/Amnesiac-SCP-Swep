...
SWEP.Author = "BIBI"
SWEP.Purpose = "Une seringue amnésiante de classe D qui fera oublier les évènements des dernières semaines."
...
SWEP.PrintName = "Amnésique Classe D"
SWEP.Slot = 1
SWEP.SlotPos = 1
SWEP.DrawAmmo = false
...
SWEP.Primary.Ammo = "AmnesiacSyringeD"
