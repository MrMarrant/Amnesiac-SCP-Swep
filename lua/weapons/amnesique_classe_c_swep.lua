...
SWEP.Author = "BIBI"
SWEP.Purpose = "Une seringue amnésiante de classe C qui fera oublier les évènements des derniers jours."
...
SWEP.PrintName = "Amnésique Classe C"
SWEP.Slot = 1
SWEP.SlotPos = 1
SWEP.DrawAmmo = false
...
SWEP.Primary.Ammo = "AmnesiacSyringeC"
