...
SWEP.Author = "BIBI"
SWEP.Purpose = "Une seringue amnésiante de classe B qui fera oublier les évènements des dernières heures."
...
SWEP.PrintName = "Amnésique Classe B"
SWEP.Slot = 1
SWEP.SlotPos = 1
SWEP.DrawAmmo = false
...
SWEP.Primary.Ammo = "AmnesiacSyringeB"
