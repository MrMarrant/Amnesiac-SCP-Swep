...
SWEP.Author = "BIBI"
SWEP.Purpose = "Une seringue amnésiante de classe F qui fera tout oublier au joueur et il sera manipulable."
...
SWEP.PrintName = "Amnésique Classe F"
SWEP.Slot = 1
SWEP.SlotPos = 1
SWEP.DrawAmmo = false
...
SWEP.Primary.Ammo = "AmnesiacSyringeF"
